# Directly copy-pasted with care from here:
# https://github.com/Josephbakulikira/Astar-PathFinding-Python/blob/master/algorithm.py
#  I *will* one day make my own version is isn't dumb, but I just want to get pathfinding working.
class Astar:
